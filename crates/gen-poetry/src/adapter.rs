...
impl Adapter for PoetryAdapter {
    ...
    fn dispatcher_reflection(&self) -> Vec<gen_types::DispatcherVariant> {
        ...
        <crate::quirks::PoetryQuirk as TypedDispatcher>::variant_fields()
            .into_iter()
